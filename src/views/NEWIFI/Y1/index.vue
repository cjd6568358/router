<template>
  <div class="page">
    ...
    <ol class="item">
      ...
      <li>参考教程: <a target="_blank" href="https://www.right.com.cn/forum/thread-4111938-1-1.html">请老师看看NEWIFI Y1 怎么提取编程器固件的EEPROM</a></li>
    </ol>
  </div>
</template>
  ...
  methods: {
    calc() {
      ...
      fileReader.onloadend = () => {
        ...
        let buffer2g = new Uint8Array(fullBuffer.slice(0x40000, 0x4ffff));
