<template>
  <div class="page">
    ...
    <ol class="item">
      ...
      <li>参考教程: <a target="_blank" href="https://www.right.com.cn/forum/thread-3709851-1-1.html">水星MW300R V6 刷breed，提取eeprom</a></li>
    </ol>
  </div>
</template>
  ...
  methods: {
    calc() {
      ...
      fileReader.onloadend = () => {
        ...
        let buffer2g = new Uint8Array(fullBuffer.slice(0x1f0000, 0x1fffff));
