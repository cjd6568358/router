<template>
  <div class="page">
    ...
    <ol class="item">
      ...
      <li>参考教程: <a target="_blank" href="https://www.right.com.cn/forum/thread-313018-1-1.html">求帮忙提取fw310 v4的EEPROM</a></li>
    </ol>
  </div>
</template>
  ...
  methods: {
    calc() {
      ...
      fileReader.onloadend = () => {
        ...
        let buffer2g = new Uint8Array(fullBuffer.slice(0x00fc00));
